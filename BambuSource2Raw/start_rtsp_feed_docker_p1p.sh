...
while :
do
    /bambu-bin/bambusource2raw start_stream_local -s $P1PIP -a $P1PACCESSCODE | /bambu-bin/ffmpeg -hide_banner -loglevel error -i - -c copy -f rtsp rtsp://127.0.0.1:8554/bbl
    sleep 30
    start_rtsp_server
done
popd